-- Insert's tb_cliente
insert into tb_cliente(celular, pais, data_vencimento, nome, status) values('21988888880', 'Brazil', '2025-01-15', 'Pedro', 'EXPIRADO');
insert into tb_cliente(celular, pais, data_vencimento, nome, status) values('21988888881', 'Brazil', '2025-01-27', 'Paulo', 'VENCENDO_HOJE');
insert into tb_cliente(celular, pais, data_vencimento, nome, status) values('21988888882', 'Brazil', '2025-01-30', 'João', 'A_VENCER');
